...
exports.delete = (event, context, callback) => {
    ...
    dbDelete(params).then( (data) => {
        ...
        console.log(`DELETED ITEM SUCCESSFULLY WITH id = ${event.pathParameters.productId}`);
        callback(null, createResponse(200, null));
    }).catch( (err) => {
        console.log(`DELETE ITEM FAILED FOR id = ${event.pathParameters.productId}, WITH ERROR: ${err}`);
        callback(null, createResponse(500, err));
    });
};
